        ...
        <va-card class="larger-padding">
          ...
          <va-card-content class="row">
            <div class="flex">
              ...
              <va-button class="mr-2 mb-2" icon-right="ion_arrow_down">
                {{ $t('buttons.button') }}
              </va-button>
      ...
      <div class="flex xs12">
        <va-card class="larger-padding">
          ...
          <va-card-content>
            ...
            <div class="row">
              <div class="flex">
                <va-button class="mr-2 mb-2" outline color="danger">
                  {{ $t('buttons.danger') }}
                </va-button>
                <va-button class="mr-2 mb-2" outline color="info">
                  {{ $t('buttons.info') }}
                </va-button>
                <va-button class="mr-2 mb-2" outline color="dark">
                  {{ $t('buttons.dark') }}
                </va-button>
                <va-button class="mr-2 mb-2" outline color="warning">
                  {{ $t('buttons.warning') }}
                </va-button>
                <va-button class="mr-2 mb-2" outline color="success">
                  {{ $t('buttons.success') }}
                </va-button>
                <va-button class="mr-2 mb-2" outline color="gray">
                  {{ $t('buttons.gray') }}
                </va-button>
              </div>
            </div>
            <div class="row">
              <div class="flex">
                <va-button class="mr-2 mb-2" flat color="danger">
                  {{ $t('buttons.danger') }}
                </va-button>
                ...
                <va-button class="mr-2 mb-2" flat color="warning">
                  {{ $t('buttons.warning') }}
                </va-button>
                <va-button class="mr-2 mb-2" flat color="success">
                  {{ $t('buttons.success') }}
                </va-button>
        ...
        <va-card class="larger-padding">
          ...
          <va-card-content>
            <div class="row">
              ...
              <div class="flex xs12 lg6">
                <va-button-toggle outline v-model="model" :options="options" color="danger" />
              </div>
              <div class="flex xs12 lg6">
                <va-button-toggle flat v-model="model" :options="options" color="gray" />
              </div>
              <div class="flex xs12 lg6">
              ...
              <div class="flex xs12 lg6">
                <va-button-toggle flat v-model="model" :options="options" color="warning" />
              </div>
            </div>
          </va-card-content>
        </va-card>
